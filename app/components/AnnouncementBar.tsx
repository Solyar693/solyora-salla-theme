...
export function AnnouncementBar() {
  ...
  return (
    <div className="solyora-announcement" role="region" aria-label={text} dir="rtl">
      <div className="solyora-announcement__track" aria-hidden="true">
        {[0, 1].map((copy) => <div className="solyora-announcement__group" key={copy}>{parts.map((part, index) => (
